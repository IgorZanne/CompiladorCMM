#ifndef INCLUDE__ABSYN_H
#define INCLUDE__ABSYN_H
...
struct A_dec_ 
    {enum {A_functionDec, A_varDec, A_typeDec} kind;
     A_pos pos;
     union {
     	struct {S_symbol name; A_fieldList params; S_symbol result; A_exp body;} function;
...
struct A_efield_ {A_pos pos; S_symbol name; A_exp exp;};
