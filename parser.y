...
%type <A_dec> function_dec nametype_dec var_dec dec
%type <A_ty> type
...
function_dec: FUNCTION ID LPAREN function_fields RPAREN EQ exp {$$=A_FunctionDec(EM_tokPos, S_Symbol($2), $4, NULL, $7);}
	| FUNCTION ID LPAREN function_fields RPAREN COLON ID EQ exp {$$=A_FunctionDec(EM_tokPos, S_Symbol($2), $4, S_Symbol($7), $9);}
